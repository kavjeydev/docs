...
```typescript
import type { QueryOptions, QueryResponse, ChunkScore } from "@react/trainly";
...
```typescript
import { RateLimiter } from "@react/trainly";
...
<html>
  <head>
    ...
    <script type="module">
      import { TrainlyClient } from "https://cdn.jsdelivr.net/npm/@react/trainly/dist/index.mjs";
...
const response = await fetch(
  "https://api.trainly.com/v1/chat_abc/answer_question",
  {
    method: "POST",
    headers: {
