...
<Note>
  The JavaScript SDK works in both Node.js and browser environments with automatic environment detection.
</Note>
...
```typescript
import { TrainlyClient, QueryResponse, UploadResponse } from '@trainly/sdk';
